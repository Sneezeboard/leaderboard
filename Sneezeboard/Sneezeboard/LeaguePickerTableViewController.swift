//
//  LeaguePickerTableViewController.swift
//  Sneezeboard
//
...
class LeaguePickerTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("cell.league", forIndexPath: indexPath) as! LeagueSelectionTableViewCell
